...
**Makowski, D.**, & Neves, A. (*under review*). [Testing the relationship between phenomenological control and illusion sensitivity](https://osf.io/preprints/psyarxiv/873th). *PsyArXiv*. (Stage 2 Registered Report)

Dickinson, R., **Makowski, D.**, van Marwijk, H., & Ford, E. (*under review*). [Bad News: Testing gamified inoculation against misinformation](https://osf.io/preprints/psyarxiv/7xgbt). *PsyArXiv*.
...
Dickinson, R., **Makowski, D.**, van Marwijk, H., & Ford, E. (2025). [Interventions for combating COVID-19 misinformation: A systematic realist review](https://doi.org/10.1371/journal.pone.0317592). *PLOS One, 20*(4), e0317592.
...
Dickinson, R., **Makowski, D.**, van Marwijk, H., & Ford, E. (2024). [Exploring the Role of News Outlets in the Rise of a Conspiracy Theory: Hydroxychloroquine in the Early Days of COVID-19](https://www.mdpi.com/2673-8112/4/12/132). *COVID, 4*(12), 1873-1896.

**Makowski, D.**, Lau, Z. J., Pham, T., Te, A. S., Kirk, S., Liauw, C., & Chen, S. A. (2024). [The heart can lie: a preliminary investigation of the role of interoception and theory of mind in deception](https://link.springer.com/article/10.1007/s12144-024-06890-w). *Current Psychology*, 1-12.

**Makowski, D.**, Te, A. S., Kirk, S., Liang, N. Z., & Chen, S. A. (2023). [A novel visual illusion paradigm provides evidence for a general factor of illusion sensitivity and personality correlates](https://doi.org/10.1038/s41598-023-33148-5). *Scientific Reports, 13*(1), 6594.
...
**Makowski, D.**, Neves, A., Benn, E., Bennett, M., & Poerio, G. (*under review*). [The Mint Scale: A fresh validation of the multimodal interoception questionnaire and comparison to the MAIA, BPQ and IAS](https://osf.io/preprints/psyarxiv/8qrht). *PsyArXiv*.

Neves, A., Pfaff, M., Scharte, R. E., Nogueira-Arjona, R., Poerio, G., & **Makowski, D.** (*under review*). [Mega-analysis of the Interoceptive Accuracy Scale (IAS) structure and its dispositional correlates](https://osf.io/preprints/psyarxiv/2mpqd). *PsyArXiv*.

Scharte, R. E., Greenwood, K., Romero Sanchiz, P., Neves, A., **Makowski, D.**, & Nogueira-Arjona, R. (*under review*). [Interoception and substance use: A systematic review and meta-analysis](https://osf.io/preprints/psyarxiv/gzv78). *PsyArXiv*.

**Makowski, D.** (*under review*). [Towards an active inference personality framework: The Deep-Self Predictive Cascade model](https://osf.io/preprints/psyarxiv/9pequ). *PsyArXiv*.


Pham, T., Johnco, C. J., Lau, Z. J., **Makowski, D.**\*, & Forbes, M. K.\* (2025). [Which heart rate variability (HRV) indices should I use for psychophysiological research? A data-driven approach to identifying clusters of HRV indices](https://doi.org/10.1111/psyp.70164). *Psychophysiology, 62*(10), e70164. (\*co-last authors)

**Makowski, D.**, Te, A. S., Neves, A., & Chen, S. H. A. (2025). [Measuring depression and anxiety with 4 items? Adaptation of the PHQ-4 to increase its sensitivity to subclinical variability](https://doi.org/10.1525/collabra.143431). *Collabra: Psychology, 11*(1), 143431.
...
**Makowski, D.**, Neves, A., & Field, A. P. (*under review*). [Introducing the Choice-Confidence (CHOCO) model for bimodal data from subjective ratings: Application to the effect of attractiveness on reality beliefs about AI-generated faces](https://osf.io/preprints/psyarxiv/z68v3). *PsyArXiv*.

**Makowski, D.** (*under review*). [The cogmod R package: Easy-to-use Bayesian cognitive models for reaction times, choices and subjective ratings, with applications to computational neuropsychology](https://osf.io/preprints/psyarxiv/5h62c). *PsyArXiv*.

Geller, J., Angele, B., & **Makowski, D.** (*under review*). [This is not the ex-Gaussian model you are looking for: On the default parameterization of Bayesian ex-Gaussian models in brms](https://osf.io/preprints/psyarxiv/kdcxa). *PsyArXiv*.

Lüdecke, D., Makowski, A. C., Klein, J., Ben-Shachar, M. S., & **Makowski, D.** (2026). [Choosing informative priors in Bayesian regression models: A simulation study and tutorial using Stan and R](https://doi.org/10.3389/fpsyg.2026.1856582). *Frontiers in Psychology, 17*, 1856582.

Fernandez, K., **Makowski, D.**, & Fisher, C. (2025). [SequentialSamplingModels.jl: Simulating and evaluating cognitive models of response times in Julia](https://doi.org/10.21105/jcon.00186). *JuliaCon Proceedings, 7*(78), 186.

**Makowski, D.**, & Waggoner, P. D. (2023). [Where are we going with statistical computing? From mathematical statistics to collaborative data science](https://www.mdpi.com/2227-7390/11/8/1821). *Mathematics, 11*(8), 1821.
...
**Makowski, D.**, Ben-Shachar, M. S., Wiernik, B. M., Patil, I., Thériault, R., & Lüdecke, D. (2025). [modelbased: An R package to make the most out of your statistical models through marginal means, marginal effects, and model predictions](https://doi.org/10.21105/joss.07969). *Journal of Open Source Software, 10*(109), 7969.
...
Geller, J., Gomez, P., Buchanan, E., & **Makowski, D.** (2025). [A distributional response time analysis of the perceptual disfluency effect](https://doi.org/10.5334/joc.469). *Journal of Cognition, 8*(1), 60.

Rinaldi, L. J., Agbude, R., Andermane, N., **Makowski, D.**, Forster, S., Simner, J., & Ward, J. (2026). [Attention and physiological responses to task-irrelevant sounds in misophonia](https://doi.org/10.1080/13803395.2026.2633236). *Journal of Clinical and Experimental Neuropsychology, 48*(3), 266-280.

Salgues, S., Jacquot, A., **Makowski, D.**, Tahar, C., Baekeland, J., Arcangeli, M., ... & Sperduti, M. (2024). [Self-reference and emotional reaction drive aesthetic judgment](https://www.nature.com/articles/s41598-024-68331-9). *Scientific Reports, 14*(1), 19699.

Lee, H., Jacquot, A., **Makowski, D.**, Arcangeli, M., Dokic, J., Piolino, P., & Sperduti, M. (2024). [The beauty and the self: A common mnemonic advantage between aesthetic judgment and self-reference](https://doi.org/10.1037/cns0000345). *Psychology of Consciousness: Theory, Research, and Practice, 11*(1), 71.
...
- Research featured in online journal, `r link("Attractiveness shapes beliefs about whether faces are real or AI-generated, study finds", "https://www.psypost.org/attractiveness-shapes-beliefs-about-whether-faces-are-real-or-ai-generated-study-finds/")`. 07 July 2025, psypost.org
