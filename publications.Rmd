...
**Makowski, D.**, & Neves, A. (*under review*). [Testing the relationship between phenomenological control and illusion sensitivity](https://osf.io/placeholder). *PsyArXiv*. (Stage 2 Registered Report)
...
**Makowski, D.**, Neves, A., Benn, E., & Poerio, G. (*under review*). [The Mint Scale: A fresh validation of the multimodal interoception questionnaire and comparison to the MAIA, BPQ and IAS](https://doi.org/10.31234/osf.io/placeholder). *PsyArXiv*.
...
**Makowski, D.**, Neves, A., & Field, A. P. (*under review*). [Introducing the Choice-Confidence (CHOCO) model for bimodal data from subjective ratings: Application to the effect of attractiveness on reality beliefs about AI-generated faces](https://osf.io/preprints/psyarxiv/placeholder). *PsyArXiv*.

Lüdecke, D., Makowski, A. C., Klein, J., & **Makowski, D.** (*in press*). Choosing informative priors in Bayesian regression models: A simulation study and tutorial using Stan and R. *Frontiers in Psychology*.

Fernandez, K., **Makowski, D.**, & Fisher, C. (2025). [SequentialSamplingModels.jl: Simulating and evaluating cognitive models of response times in Julia](https://doi.org/10.21105/jcon.00193). *JuliaCon Proceedings, 1*(1), 193.
