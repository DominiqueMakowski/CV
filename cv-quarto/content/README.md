...
Five files are rendered as two labelled columns of short cards rather than as
...
| Key | Renders as |
| --- | --- |
| `lead` | One italic sentence under the section heading, saying what the table is and what it is drawn from. |
